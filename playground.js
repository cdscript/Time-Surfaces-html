...
function loadJavascriptExample() {
    ...
    document.getElementById("verticalRatio").value = "0.00005";
}
...
function loadGooglespreadsheetExample() {
    var url =
        "https://docs.google.com/spreadsheets/d/1AgDMRBpCuSPpIthOokFN6YotfFoOPQqdBZHFuyRJfQM/edit?usp=sharing";

    document.getElementById("googlespreadsheetText").value = url;

    document.getElementById("verticalRatio").value = "0.000005";
}
